...
`}function d(r){return r.map(u).join("")}const a={formElem:document.querySelector(".form"),ulElem:document.querySelector(".js-gallery"),loader:document.querySelector(".loader")};a.formElem.addEventListener("submit",p);function p(r){r.preventDefault();const o=r.target.elements.searchField.value;h(),m(o).then(s=>{s.total===0&&y();const i=d(s.hits);a.ulElem.innerHTML=i,c.refresh()}).catch(()=>{v()}).finally(()=>{g()}),a.formElem.reset()}const c=new f(".gallery a",{captionsData:"alt",captionDelay:250});c.refresh();function h(){a.loader.classList.remove("hidden")}function g(){a.loader.classList.add("hidden")}function y(){l.error({title:"",message:"Sorry, there are no images matching your search query. Please try again!",messageLineHeight:"1.5",messageSize:"16",messageColor:"#fff",position:"topRight",backgroundColor:"#ef4040",icon:!1})}function v(){l.warning({title:"",message:"Sorry! There was a problem with the server!",messageLineHeight:"1.5",messageSize:"16",messageColor:"#fff",position:"topRight",backgroundColor:"#ef4040",icon:!1})}
